...
class IpccCharacterizationFactorsSource(RootModel[str]):
...
class CrossSectoralStandard(Enum):
    ISO14067 = 'ISO14067'
    ISO14083 = 'ISO14083'
    ISO14040_44 = 'ISO14040-44'
    GHGP_Product = 'GHGP-Product'
    PEF = 'PEF'
    PACT_1_0 = 'PACT-1.0'
    PACT_2_0 = 'PACT-2.0'
    PACT_3_0 = 'PACT-3.0'
...
class CarbonFootprint1(BaseModel):
    ...
    crossSectoralStandards: Annotated[
        Optional[list[CrossSectoralStandard]],
        Field(
...
class ProductFootprint(BaseModel):
    ...
    productClassifications: Annotated[
        Optional[list[Urn]],
        Field(
            description='The non-empty set of [=ProductClassifications=] in [=URN=] format. Each of the values in the set can classify the product as part of distinct groupings and categorizations. See {#product-identifiers}. \n\nAdvisement: Supersedes productCategoryCpc deprecated in version 2.3.\n',
            min_length=1,
        ),
    ] = None
