...
router.get("/directory/companies/verify-reset-token/:token", CompanyController.verifyResetToken);

// Company profile and search
router.get("/directory/companies/my-profile", authenticate, CompanyController.myProfile);
router.get("/directory/companies/profile/:id", authenticate, CompanyController.getCompany);
